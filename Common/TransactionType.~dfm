inherited TransactionTypeForm: TTransactionTypeForm
  ...
  inherited plGrid: TPanel
    ...
    inherited DBGrid: TwwDBGrid
      ...
      Height = 215
      ControlType.Strings = (
        'DEFAULT_MODULE;CustomEdit;cbModule;F'
      ...
      Selected.Strings = (
        ...
        'CURRENT_NO'#9'10'#9'CURRENT_NO'#9'F'#9)
    end
    object cbModule: TwwDBLookupCombo
      Left = 168
      Top = 40
      Width = 121
      Height = 21
      ...
      LookupTable = CommonShareDM.tbSysModule
  ...
  inherited dataSource: TDataSource
    DataSet = CommonShareDM.TransactionType
  end
end
