inherited SystemMenuDM: TSystemMenuDM
  ...
  object tbSysMenu: TIBTable
    ...
    Left = 192
    Top = 96
    object tbSysMenuFORM_NAME: TIBStringField
      FieldName = 'FORM_NAME'
      Size = 25
    end
    object tbSysMenuMENU_INDEX: TSmallintField
      FieldName = 'MENU_INDEX'
    end
    object tbSysMenuMODULE_ID: TIBStringField
      FieldName = 'MODULE_ID'
      Size = 4
    end
    object tbSysMenuMENU_ITEM_INDEX: TSmallintField
      FieldName = 'MENU_ITEM_INDEX'
    end
    object tbSysMenuFORM_CAPTION: TIBStringField
      FieldName = 'FORM_CAPTION'
      Size = 60
    end
    object tbSysMenuENABLED: TIBStringField
      FieldName = 'ENABLED'
      Size = 1
    end
    object tbSysMenuUPDATE_DATE: TDateTimeField
      FieldName = 'UPDATE_DATE'
    end
    object tbSysMenuUPDATE_USER: TIBStringField
      FieldName = 'UPDATE_USER'
      Size = 10
    end
    object tbSysMenuFORM_TAG: TSmallintField
      FieldName = 'FORM_TAG'
    end
    object tbSysMenuHISTORY_CAPTION: TIBStringField
      FieldName = 'HISTORY_CAPTION'
      Size = 60
    end
    object tbSysMenuMAIN_MENU_NAME: TIBStringField
      FieldName = 'MAIN_MENU_NAME'
      Size = 30
    end
    object tbSysMenuREPORTID: TIBStringField
      FieldName = 'REPORTID'
      Size = 60
    end
    object tbSysMenuQUERYSTRING: TMemoField
  ...
  object qrySysMenuByModuleID: TIBQuery
    ...
    object qrySysMenuByModuleIDREPORTID: TIBStringField
      FieldName = 'REPORTID'
      Origin = 'SYS_MENUS.REPORTID'
      Size = 60
    end
    object qrySysMenuByModuleIDQUERYSTRING: TMemoField
      FieldName = 'QUERYSTRING'
      Origin = 'SYS_MENUS.QUERYSTRING'
      BlobType = ftMemo
      Size = 8
    end
  end
