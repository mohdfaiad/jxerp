...
uses
  ...
  cxMaskEdit, cxControls, cxContainer, cxEdit, cxTextEdit,frxClass;
...
procedure     TBaseUIMasterDetailForm.doReportFilter(SENDER:TObject);
begin
   //
end;
...
begin
   ...
   begin
    begin
      ...
      buttonSelected := messagedlg('Do you want to design report',mtCustom,
                              [mbYes,mbCancel], 0);
   ...
   begin
      warning('There is no report defined for this windows');
   end;
end;
