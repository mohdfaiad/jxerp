...
implementation
uses accountReceiveDataModule,InvoiceLineEdit,CommonShareDataModule,
  ReportDataModule;
...
procedure TInvoiceForm.sbtPrintClick(Sender: TObject);
begin
  inherited;
  doPrintPreview(sender);
end;

procedure TInvoiceForm.doReportFilter(sender:TObject);
begin
