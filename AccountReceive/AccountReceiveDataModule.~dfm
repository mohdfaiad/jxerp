inherited AccountReceiveDM: TAccountReceiveDM
  ...
  object tbReceiptHD: TIBTable
    ...
    object tbReceiptHDREQUIRE_REFERENCE: TIBStringField
      FieldName = 'REQUIRE_REFERENCE'
      Size = 1
    end
  end
  object tbReceiptDT: TIBTable
    ...
    object tbReceiptDTBASE_AMOUNT: TFloatField
      ...
      OnChange = tbReceiptDTBASE_AMOUNTChange
    end
    object tbReceiptDTWH_RATE: TFloatField
      DisplayWidth = 10
      FieldName = 'WH_RATE'
      OnChange = tbReceiptDTWH_RATEChange
    end
    object tbReceiptDTTAX_RATE: TFloatField
      DisplayWidth = 10
      FieldName = 'TAX_RATE'
      OnChange = tbReceiptDTBASE_AMOUNTChange
    end
    object tbReceiptDTWH_AMOUNT: TFloatField
      DisplayLabel = 'Witholding Tax'
      DisplayWidth = 10
      FieldName = 'WH_AMOUNT'
    end
    ...
    object tbReceiptDTUNIT_COST: TFloatField
      DisplayWidth = 10
      FieldName = 'UNIT_COST'
      Visible = False
    end
    object tbReceiptDTQTY: TFloatField
      DisplayWidth = 10
      FieldName = 'QTY'
      Visible = False
    end
  ...
  object qryOutstandingInvoice: TIBQuery
    Database = WarehouseDataManager.IBDatabase
    Transaction = WarehouseDataManager.IBTransaction
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'SELECT * FROM AR_LEDGER'
      'WHERE CLASS='#39'I'#39
      'and mbal_amt > 0')
    Left = 640
    Top = 40
  end
  object qryRevenue: TIBQuery
    Database = WarehouseDataManager.IBDatabase
    Transaction = WarehouseDataManager.IBTransaction
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      ...
      'REVENUE_AMOUNT,'
      'TAXDIFF_AMOUNT'
      'from x_get_revenue(:pyear,:pmonth,:pflag)')
    Left = 656
    Top = 112
    ParamData = <
      item
    ...
    object qryRevenuePURCHASETAX_AMOUNT: TIntegerField
      DisplayWidth = 10
      FieldName = 'PURCHASETAX_AMOUNT'
      Origin = 'X_GET_REVENUE.PURCHASETAX_AMOUNT'
    end
    object qryRevenuePURCHASEBASE_AMOUNT: TFloatField
      DisplayWidth = 10
      FieldName = 'PURCHASEBASE_AMOUNT'
      Origin = 'X_GET_REVENUE.PURCHASEBASE_AMOUNT'
    end
    object qryRevenueSALETAX_AMOUNT: TFloatField
      DisplayWidth = 10
      FieldName = 'SALETAX_AMOUNT'
      Origin = 'X_GET_REVENUE.SALETAX_AMOUNT'
    end
    object qryRevenueSALEBASE_AMOUNT: TFloatField
      DisplayWidth = 10
      FieldName = 'SALEBASE_AMOUNT'
      Origin = 'X_GET_REVENUE.SALEBASE_AMOUNT'
    end
    object qryRevenueREVENUE_AMOUNT: TFloatField
      DisplayWidth = 10
      FieldName = 'REVENUE_AMOUNT'
      Origin = 'X_GET_REVENUE.REVENUE_AMOUNT'
    end
    object qryRevenueTAXDIFF_AMOUNT: TFloatField
      DisplayWidth = 10
      FieldName = 'TAXDIFF_AMOUNT'
      Origin = 'X_GET_REVENUE.TAXDIFF_AMOUNT'
    end
  end
end
