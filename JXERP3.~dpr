...
uses
  ...
  ARLedgerInquiry in 'AccountReceive\ARLedgerInquiry.pas' {frmDebtorLedgerInquiry},
  ...
  CommonShareDataModule in 'AP\CommonShareDataModule.pas' {CommonShareDM: TDataModule},
  ...
  ReportDataModule in 'datamodule\ReportDataModule.pas' {ReportDM: TDataModule},
  ReportDesign in 'ReportDesign\ReportDesign.pas' {frmReportDesigner},
  AccountPayableDataModule in 'datamodule\AccountPayableDataModule.pas' {AccountPayableDM: TDataModule},
  APPaymentForm in 'AP\APPaymentForm.pas' {frmAPPayment},
  APPaymentManagerForm in 'AP\APPaymentManagerForm.pas' {frmAPPaymentManager},
  SaleOrderTrack in 'SaleOrder\SaleOrderTrack.pas' {frmSaleOrderTrack},
  CompanySetupForm in 'Common\CompanySetupForm.pas' {frmCompanySetup},
  wcrypt2 in 'Lib\CrypToAPI2\Pas\Wcrypt2.pas',
  cryptoText in 'TestUnit\cryptoText.pas' {frmTestEncrypt},
  JXCrypto in 'util\JXCrypto.pas',
  ReportListDialog in 'Common\ReportListDialog.pas' {frmReportDialog},
  BaseDialogReportForm in 'ReportUI\BaseDialogReportForm.pas' {BaseReportDialog},
  APPurchaseVATReport in 'ReportUI\APPurchaseVATReport.pas' {frmAPPurchaseVatReport},
  APInvoiceForm in 'AP\APInvoiceForm.pas' {frmAPInvoice},
  APInvoiceManagerForm in 'AP\APInvoiceManagerForm.pas' {frmAPInvoiceManager},
  AROutstandingReport in 'ReportUI\AROutstandingReport.pas' {frmAROutstandingReport},
  AROUTPUTVatReport in 'ReportUI\AROUTPUTVatReport.pas' {frmAROutputVatReport};
...
try
  ...
  SplashForm.Show;
  SplashForm.Cursor:=crSQLWait;
  Application.Title := 'JX@ERP';
  Application.CreateForm(TWarehouseDataManager, WarehouseDataManager);
  SplashForm.Update('Creating warehouse data..');
  SplashForm.refresh;
  Application.CreateForm(TCommonShareDM, CommonShareDM);
  ...
  SplashForm.refresh;
  //23 Nov,2012 add new runtime report library
  Application.CreateForm(TReportDM, ReportDM);
  SplashForm.Update('Creating Report data..');
  SplashForm.refresh;

  //2 Jan,2012
  Application.CreateForm(TAccountPayableDM, AccountPayableDM);
  RController:=TRuntimeController.create;
  SplashForm.Update('Creating Account Payable data..');
  SplashForm.refresh;
  Application.CreateForm(TformMain, formMain);
  SplashForm.Cursor:=crDefault;
  SplashForm.Hide;
  ...
  Application.Run;
   ...
   // Application.MessageBox('Fatal Error Application is about to exit!','Application Error',1);
