...
type
  TfrmCXSaleOrderManager = class(TcxAbstractDataBrowse)
    ...
    procedure btTrackClick(Sender: TObject);
  private
...
implementation
uses SaleOrderDataModule,saleOrder,SaleOrderTrack;
...
procedure TfrmCXSaleOrderManager.btTrackClick(Sender: TObject);

begin

      frmSaleOrderTrack :=TfrmSaleOrderTrack.Create(self);
      frmSaleOrderTrack.ShowModal;
      frmSaleOrderTrack.Free
