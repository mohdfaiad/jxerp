...
type
  TAccountPayableDM = class(TAbstractDM)
    ...
    qryUnpostAPPaymentNetAmount: TFloatField;
    ...
    procedure qryUnpostAPPaymentCalcFields(DataSet: TDataSet);
  private
...
procedure TAccountPayableDM.qryUnpostAPPaymentCalcFields(
  DataSet: TDataSet);
begin
  qryUnpostAPPaymentNetAmount.AsFloat :=    qryUnpostAPPaymentBase_Amount.AsFloat -   qryUnpostAPPaymentWHTAX_AMOUNT.AsFloat;
