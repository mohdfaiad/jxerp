...
implementation
uses purchaseorderform, ReportDataModule;
...
begin
  ...
  ,'ORDER_NO',0);
  frmPurchaseOrder.reportId:=REPORTID;
      frmPurchaseOrder.queryString := queryString;
  frmPurchaseOrder.frxReport :=REPORTDM.frxReport;
...
procedure    TfrmPurchaseOrderBrowse.doReportFilter(Sender:TObject);
begin
   ...
   Reportdm.JXNativeQuery.ParamByName('PDOCNO').Value :=dataSource.DataSet.Fieldbyname('ORDER_NO').AsString;
