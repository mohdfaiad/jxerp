...
uses
  ...
  cxControls, fcTreeView,  dxBar, cxClasses,DB, dxBarExtItems,
  cxSplitter, cxBarEditItem,Progress;


CONST TREEVIEW_ROOT_CONTEXT ='JX@ERP\\ROOT'      ;
...
reportDesign,AROUTPUTVatReport;
...
begin
   ...
   ROOT:=treeViewMain.Items.AddFirst(NIL,TREEVIEW_ROOT_CONTEXT);
   ROOT.ImageIndex :=0;
   try
   ...
   begin
      ...
      begin
         ...
         begin
           ...
           child:=treeViewMain.Items.AddChild(node ,'Report');   //report sub menu
           child.Selected;
           child.ImageIndex:=6;
           generateChildItems(child,moduleID,2);
...
//   frmReportDesigner :=TFrmReportDesigner .create(self);
  // frmReportDesigner.show;
    frmAROutputVatReport.ShowModal;
